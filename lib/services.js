export const services = [
  {
    ...
    officialSource: "https://tg.meeseva.gov.in",
  ...
  },
  {
    ...
    steps: {
      en: ["Visit MeeSeva centre or tg.meeseva.gov.in", "Select 'Revenue' → 'Caste Certificate'", "Fill in personal and family details", "Upload all required documents", "Pay the prescribed fee (approx. ₹35–₹45)", "Application forwarded to Tahsildar for field verification", "Certificate issued after verification (15–30 working days)"],
      hi: ["MeeSeva केंद्र जाएं या tg.meeseva.gov.in पर जाएं", "'Revenue' → 'Caste Certificate' चुनें", "व्यक्तिगत और पारिवारिक विवरण भरें", "सभी आवश्यक दस्तावेज़ अपलोड करें", "निर्धारित शुल्क दें (लगभग ₹35–₹45)", "क्षेत्र सत्यापन के लिए आवेदन तहसीलदार को भेजा जाएगा", "सत्यापन के बाद प्रमाण पत्र जारी होगा (15–30 कार्य दिवस)"],
      te: ["మీసేవ కేంద్రానికి వెళ్లండి లేదా tg.meeseva.gov.in కి వెళ్లండి", "'Revenue' → 'Caste Certificate' ఎంచుకోండి", "వ్యక్తిగత మరియు కుటుంబ వివరాలు నింపండి", "అన్ని అవసరమైన పత్రాలు అప్‌లోడ్ చేయండి", "నిర్ణీత రుసుము చెల్లించండి (సుమారు ₹35–₹45)", "ఫీల్డ్ వెరిఫికేషన్ కోసం అప్లికేషన్ తహసీల్దార్‌కు పంపబడుతుంది", "ధృవీకరణ తర్వాత సర్టిఫికేట్ జారీ అవుతుంది (15–30 పని దినాలు)"]
    },
    mistakes: {
  ...
  },
  {
    ...
    steps: {
      en: ["Visit MeeSeva centre or tg.meeseva.gov.in", "Select 'Revenue' → 'Residence/Domicile Certificate'", "Enter personal and address details", "Upload required documents", "Pay fee (approx. ₹35)", "Tahsildar verifies residence through records or field visit", "Certificate issued within 7–10 working days"],
      hi: ["MeeSeva केंद्र जाएं या tg.meeseva.gov.in पर जाएं", "'Revenue' → 'Residence/Domicile Certificate' चुनें", "व्यक्तिगत और पता विवरण दर्ज करें", "आवश्यक दस्तावेज़ अपलोड करें", "शुल्क दें (लगभग ₹35)", "तहसीलदार रिकॉर्ड या फील्ड विजिट से निवास सत्यापित करेगा", "7–10 कार्य दिवसों में प्रमाण पत्र जारी होगा"],
      te: ["మీసేవ కేంద్రానికి వెళ్లండి లేదా tg.meeseva.gov.in కి వెళ్లండి", "'Revenue' → 'Residence/Domicile Certificate' ఎంచుకోండి", "వ్యక్తిగత మరియు చిరునామా వివరాలు నమోదు చేయండి", "అవసరమైన పత్రాలు అప్‌లోడ్ చేయండి", "రుసుము చెల్లించండి (సుమారు ₹35)", "తహసీల్దార్ రికార్డులు లేదా ఫీల్డ్ విజిట్ ద్వారా నివాసాన్ని ధృవీకరిస్తారు", "7–10 పని దినాల్లో సర్టిఫికేట్ జారీ అవుతుంది"]
    },
    mistakes: {
