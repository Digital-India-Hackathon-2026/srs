...
const DATA = {
  ...
  "voter-id": {
    ...
    whereToApply: { en: "voterportal.eci.gov.in / ERO Office", te: "voterportal.eci.gov.in / ERO కార్యాలయం", hi: "voterportal.eci.gov.in / ERO कार्यालय" },
    ...
    steps: { en: ["Visit voterportal.eci.gov.in", "Fill Form 6", "Upload documents", "BLO verification", "Card dispatched by post"], te: ["voterportal.eci.gov.in సందర్శించండి", "ఫారం 6 నింపండి", "పత్రాలు అప్‌లోడ్ చేయండి", "BLO వెరిఫికేషన్", "పోస్ట్ ద్వారా కార్డు డిస్పాచ్"], hi: ["voterportal.eci.gov.in पर जाएँ", "फॉर्म 6 भरें", "दस्तावेज़ अपलोड करें", "BLO सत्यापन", "डाक से कार्ड भेजा जाता है"] },
