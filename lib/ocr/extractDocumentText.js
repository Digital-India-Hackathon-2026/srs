...
async function extractWithTesseract(buffer) {
  // Tesseract.js removed — Vision AI (Gemini/OpenAI) is the primary OCR method.
  // If neither Vision API is available, extraction will fail gracefully.
  throw new Error("Tesseract.js is not available. Please configure GEMINI_API_KEY or OPENAI_API_KEY for OCR.");
}
