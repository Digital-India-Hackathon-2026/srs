...
export async function extractStructuredFields(buffer, mimeType = "image/jpeg", docType = "aadhaar") {
  ...
  const fallbackMsg = !geminiKey && !openaiKey
    ? "OCR is not available because no Vision API keys are configured (GEMINI_API_KEY or OPENAI_API_KEY). Please enter the details manually."
