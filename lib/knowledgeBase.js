...
export const knowledgeBase = {
  ...
  "voter-id": {
    ...
    whereToApply: "voters.eci.gov.in or Electoral Registration Officer (ERO) office",
    lastVerified: "2026-07-01",
    ...
    documentsRequired: ["Age proof (Aadhaar / Birth certificate / School certificate)", "Address proof (Aadhaar / Electricity bill)", "Passport-size photograph", "Form 6 (for new registration — available on voters.eci.gov.in)"],

    applicationSteps: [
      "Step 1 — Visit voters.eci.gov.in or voters.eci.gov.in",
