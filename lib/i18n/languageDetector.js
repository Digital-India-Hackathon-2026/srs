...
export const FALLBACK_MESSAGES = {
  en: "I could not verify this information from the available official sources. Please check the official portal.",
  te: "అందుబాటులో ఉన్న అధికారిక మూలాల నుంచి ఈ సమాచారాన్ని ధృవీకరించలేకపోయాను. దయచేసి అధికారిక పోర్టల్‌ను పరిశీలించండి.",
  hi: "उपलब्ध आधिकारिक स्रोतों से इस जानकारी की पुष्टि नहीं हो सकी। कृपया आधिकारिक पोर्टल देखें।",
};
