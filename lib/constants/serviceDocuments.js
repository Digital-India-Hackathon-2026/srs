...
export const SERVICE_DOCUMENTS = {
  ...
  "income-certificate": {
    ...
    draftRoute: "/application-draft/income-certificate",
    required: [
      {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  "caste-certificate": {
    name: "Caste Certificate (SC / ST / BC-OBC)",
    officialPortal: "https://meeseva.telangana.gov.in",
    draftRoute: "/application-draft/caste-certificate",
    required: [
      {
        id: "aadhaar", label: "Aadhaar Card", hint: "Mandatory — identity, DOB, and address proof",
        ocrEnabled: true, ocrType: "aadhaar",
        ocrFields: ["fullName", "dateOfBirth", "gender", "aadhaarNumber", "address", "district", "state", "pinCode", "fatherName"],
      },
      {
        id: "photo", label: "Passport-size Photograph", hint: "Mandatory — recent photograph",
        ocrEnabled: false, ocrType: "photo", ocrFields: [],
      },
      {
        id: "addressProof", label: "Address Proof", hint: "Mandatory — Ration Card / Voter ID / Utility Bill",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "address", "cardNumber", "city", "pinCode"],
      },
      {
        id: "communityProof", label: "Community / Caste Proof", hint: "Mandatory — existing certificate or relevant document",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "caste", "subCaste", "certificateNumber", "issuingAuthority"],
      },
      {
        id: "schoolCert", label: "School / Transfer Certificate", hint: "Mandatory — must mention caste/community from last institution",
        ocrEnabled: true, ocrType: "generic",
    ...
    optional: [
      {
        id: "parentCasteCert", label: "Parent's Caste Certificate", hint: "If available — strengthens application",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "caste", "subCaste", "certificateNumber", "issuingAuthority"],
      },
      {
        id: "affidavit", label: "Supporting Affidavit", hint: "Notarized affidavit on stamp paper (if applicable)",
        ocrEnabled: false, ocrType: "generic", ocrFields: [],
      },
      {
        id: "birthCert", label: "Birth Certificate", hint: "For DOB cross-verification",
        ocrEnabled: true, ocrType: "generic",
  ...
  "residence-certificate": {
    ...
    officialPortal: "https://meeseva.telangana.gov.in",
    draftRoute: "/application-draft/residence-certificate",
    required: [
      {
        id: "aadhaar", label: "Aadhaar Card",
  ...
  "birth-certificate": {
    ...
    draftRoute: "/application-draft/birth-certificate",
    required: [
      {
  ...
  "death-certificate": {
    ...
    officialPortal: "https://crsorgi.gov.in",
    draftRoute: "/application-draft/death-certificate",
    required: [
      {
  ...
  "aadhaar-update": {
    ...
    draftRoute: "/application-draft/aadhaar-update",
    required: [
      {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // PAN CARD — Source: incometax.gov.in / protean-tinpan.com / utiitsl.com
  // Forms: Form 49A (Indian), Form 49AA (Foreign), PAN Change Request
  // ═══════════════════════════════════════════════════════════════════════════
  "pan-card": {
    name: "PAN Card (New / Correction / Lost-Duplicate)",
    officialPortal: "https://www.incometax.gov.in",
    draftRoute: "/application-draft/pan-card",
    required: [
      {
        id: "aadhaar", label: "Aadhaar Card", hint: "Mandatory — proof of identity, DOB, and address for PAN",
        ocrEnabled: true, ocrType: "aadhaar",
        ocrFields: ["fullName", "dateOfBirth", "gender", "aadhaarNumber", "address", "city", "district", "state", "pinCode", "fatherName"],
      },
      {
        id: "photo", label: "Passport-size Photograph", hint: "Mandatory — recent, white background",
        ocrEnabled: false, ocrType: "photo", ocrFields: [],
      },
      {
        id: "signature", label: "Signature Image", hint: "Mandatory — signature on white paper, scanned/photo",
        ocrEnabled: false, ocrType: "photo", ocrFields: [],
      },
      {
        id: "identityProof", label: "Identity Proof", hint: "Mandatory — Voter ID / Passport / Driving Licence",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "documentNumber"],
      },
      {
        id: "addressProof", label: "Address Proof", hint: "Mandatory — Utility Bill / Bank Statement / Passport",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "address", "city", "state", "pinCode"],
      },
      {
        id: "dobProof", label: "Date of Birth Proof", hint: "Mandatory — Birth Certificate / 10th Marksheet / Passport",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "dateOfBirth"],
      },
    ],
    optional: [
      {
        id: "existingPan", label: "Existing PAN Card (for correction/update/lost)", hint: "Required for correction/update or lost PAN re-issue",
        ocrEnabled: true, ocrType: "pan",
        ocrFields: ["fullName", "fatherName", "dateOfBirth", "panNumber"],
      },
    ],
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // RATION CARD — Source: meeseva.telangana.gov.in (Telangana Civil Supplies)
  // ═══════════════════════════════════════════════════════════════════════════
  "ration-card": {
    name: "Ration Card (New / Correction / Addition)",
    officialPortal: "https://meeseva.telangana.gov.in",
    draftRoute: "/application-draft/ration-card",
    required: [
      {
        id: "headAadhaar", label: "Head of Family Aadhaar Card",
        hint: "Aadhaar of the head of the family — name, DOB, gender, address",
        ocrEnabled: true, ocrType: "aadhaar",
        ocrFields: ["fullName", "dateOfBirth", "gender", "aadhaarNumber", "address", "city", "district", "state", "pinCode"],
      },
      {
        id: "addressProof", label: "Address Proof",
        hint: "Electricity Bill / Property Tax Receipt / Bank Passbook / Rent Agreement",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["address", "city", "district", "state", "pinCode"],
      },
      {
        id: "identityProof", label: "Identity Proof of Head of Family",
        hint: "Voter ID / PAN / Passport / Driving Licence",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "documentNumber", "dateOfBirth"],
      },
      {
        id: "photo", label: "Passport-size Photograph",
        hint: "Recent colour photograph of head of family, white background",
        ocrEnabled: false, ocrType: "photo", ocrFields: [],
      },
    ],
    optional: [
      {
        id: "existingCard", label: "Existing Ration Card (for correction / addition)",
        hint: "Current ration card if updating or adding members to existing card",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["cardNumber", "fullName", "address", "familyMembers"],
      },
      {
        id: "incomeProof", label: "Income Proof (if applicable)",
        hint: "Salary slip / IT Return / BPL Certificate / Self-declaration",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["fullName", "incomeAmount", "financialYear"],
      },
      {
        id: "familyAadhaar", label: "Aadhaar of Other Family Members",
        hint: "Aadhaar cards of spouse, children, and dependents for family list",
        ocrEnabled: true, ocrType: "aadhaar",
        ocrFields: ["fullName", "dateOfBirth", "gender", "aadhaarNumber"],
      },
      {
        id: "lpgDoc", label: "LPG Connection Document (if applicable)",
        hint: "LPG consumer number / distributor proof for LPG subsidy link",
        ocrEnabled: true, ocrType: "generic",
        ocrFields: ["consumerNumber", "distributorName", "fullName", "address"],
      },
    ],
  },
