/**
 * OCR API for Death Certificate Draft Generator
 * Extracts details from Hospital Death Record, Applicant Aadhaar, Deceased ID.
...
export async function POST(req) {
  try {
    ...
    // Process Deceased's Identity Proof
    if (deceasedIdFile) {
