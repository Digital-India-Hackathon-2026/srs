  ...
  try {
    ...
    if (hospitalRecordFile) {
      try {
        ...
        progress.push("Error processing birth record: " + e.message);
      }
    }
    ...
    if (parentAadhaarFile) {
      try {
        ...
        progress.push("Error processing mother's Aadhaar: " + e.message);
      }
    }
    ...
    if (fatherAadhaarFile) {
      try {
        ...
        progress.push("Error processing father's Aadhaar: " + e.message);
      }
    }
    ...
    if (marriageCertFile) {
      try {
        ...
        progress.push("Error processing marriage certificate: " + e.message);
      }
    }
